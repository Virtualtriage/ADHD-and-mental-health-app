...
const BookAppointmentModal = ({
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      submissionData.append("appointment_fee", appointmentType === 'initial' ? initialAppointmentFee : followUpAppointmentFee);
    ...
    <div className="book-appointment-modal-overlay">
              ...
              <div className="payment-section">
                ...
                <div className="payment-summary">
                  <div className="payment-item">
                    ...
                    <span className="payment-value">£{appointmentType === 'initial' ? initialAppointmentFee : followUpAppointmentFee}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="confirmation-section">
                <div className="confirmation-grid">
                  ...
                  <div className="confirmation-item">
                    ...
                    <span className="confirmation-value">£{appointmentType === 'initial' ? initialAppointmentFee : followUpAppointmentFee}</span>
                  </div>
                </div>
      ...
      <StripePaymentModal
        ...
        appointmentData={{
          ...
          amount: appointmentType === 'initial' ? initialAppointmentFee : followUpAppointmentFee,
          scheduleData: scheduleData || {
            initial_appointment_fee: initialAppointmentFee,
            follow_up_appointment_fee: followUpAppointmentFee,
            Currency: "£"
          },
          package_info: scheduleData?.package_info,
          token: localStorage.getItem("authToken") || sessionStorage.getItem("authToken") // Get auth token from localStorage or sessionStorage
        }}
